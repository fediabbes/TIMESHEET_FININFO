...
public class UserService implements UserRepository {
    ...
    public ResponseEntity<User> updateUser(Long id, User userDetails) {
        ...
        user.setDate_de_naissance(userDetails.getDate_de_naissance());
        user.setDate_embauche(userDetails.getDate_embauche());
        user.setSexe(userDetails.getSexe());
        user.setSolde(userDetails.getSolde());
        user.setRoles(userDetails.getRoles());
        user.setType_contrat(userDetails.getType_contrat());
